...
void SceneSprings::start() {
	...
	Particle* p1 = new Particle(PxVec3(10, 30, 0), PxVec3(0), PxVec3(0), PxVec4(0.8, 0.2, 0.3, 1.), 1.f, 3.f,DBL_MAX, DBL_MAX);
	...
	p1 = new Particle(PxVec3(20, 30, 0), PxVec3(0), PxVec3(0), PxVec4(0.3, 0.2, 0.8, 1.), 1.f, 3.f, DBL_MAX, DBL_MAX);
	p2 = new Particle(PxVec3(20, 5, 0), PxVec3(0), PxVec3(0), PxVec4(0.6, 0.4, 0.9, 1.), 1.f, 3.f, DBL_MAX, DBL_MAX);
	springGen->setParticles(p1, p2);
