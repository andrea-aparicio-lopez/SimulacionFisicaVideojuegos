...
void SceneSprings::start() {
	...
	_anchor = new Target(PxVec3(-10, 30,10), PxVec3(1.5f));
	...
	_pAnchored = new Particle(_anchor->transform()->p - PxVec3(0,20,0), PxVec3(0), PxVec3(0), PxVec4(0.2, 0.9, 0.1, 1.), 1.f, 3.f, DBL_MAX, DBL_MAX);
	...
	Particle* p1 = new Particle(PxVec3(10, 30, 0), PxVec3(0), PxVec3(0), PxVec4(0.8, 0.2, 0.1, 1.), 1.f, 3.f,DBL_MAX, DBL_MAX);
	Particle* p2 = new Particle(PxVec3(0, 10, 0), PxVec3(0), PxVec3(0), PxVec4(0.1, 0.2, 0.8, 1.), 1.f, 3.f, DBL_MAX, DBL_MAX);
